const THUMBNAILS = {
    ...
    ohMyFoodHQ: require("./oh-my-food-HQ.png"),
    directBrico: require("./direct-brico.png"),
    directBricoHQ: require("./direct-brico-HQ.png"),
    hrNet: require("./hr-net.png"),
    hrNetHQ: require("./hr-net-HQ.png"),
